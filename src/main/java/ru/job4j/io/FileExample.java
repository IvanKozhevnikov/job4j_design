...
public class FileExample {
    public static void main(String[] args) throws IOException {
        File directory = new File("C:/Users/Ivan_Kozhevnikov/IdeaProjects/job4j_design/src/main/java/ru/job4j/io/files");
        directory.mkdir();
        File file = new File("C:/Users/Ivan_Kozhevnikov/IdeaProjects/job4j_design/src/main/java/ru/job4j/io/files/file.txt");
        file.createNewFile();
